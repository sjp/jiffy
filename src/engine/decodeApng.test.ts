...
class FakeCtx {
  ...
  drawImage() {}
  putImageData() {}
  getImageData() { return new FakeImageData(this.w, this.h); }
...
const IHDR_1x1 = [
  ...
  0x00, 0x00, 0x00, 0x00,                         // CRC (parser does not validate)
];
// acTL with configurable num_frames
const actl = (n: number) => [
  0x00, 0x00, 0x00, 0x08,        // length = 8
  0x61, 0x63, 0x54, 0x4C,        // "acTL"
  (n >> 24) & 0xff, (n >> 16) & 0xff, (n >> 8) & 0xff, n & 0xff, // num_frames
  0x00, 0x00, 0x00, 0x00,        // num_plays = 0
  0x00, 0x00, 0x00, 0x00,        // CRC (fake)
];
const IDAT_1 = [
