...
const a = mount();
await act(() => render(<Readout index={11} frameCount={48} time={1200} duration={3000} />, a));
...
const b = mount();
await act(() => render(<Readout index={0} frameCount={5} time={65000} duration={125000} />, b));
assert.match(norm(b.textContent), /1:05 \/ 2:05/, "m:ss for >= 60s");

// Zero duration hides the time portion.
const c = mount();
await act(() => render(<Readout index={0} frameCount={1} time={0} duration={0} />, c));
