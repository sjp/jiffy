...
const a = mount();
act(() =>
  render(<Readout index={11} frameCount={48} time={1200} duration={3000} />, a),
);
...
act(() =>
  render(
    <Readout index={0} frameCount={5} time={65000} duration={125000} />,
    b,
  ),
);
...
const c = mount();
act(() =>
  render(<Readout index={0} frameCount={1} time={0} duration={0} />, c),
);
